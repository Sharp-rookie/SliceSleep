...
def train_td3(
    ...
    for episode in range(1, max_episodes+1):
        ...
        for iter in range(1, max_iters+1):
            ...
            # add to buffer
            td3_agent1.buffer.add((state, actions[0], rewards[0], next_state, dones[0]))
            td3_agent2.buffer.add((state, actions[1], rewards[1], next_state, dones[1]))
            td3_agent3.buffer.add((state, actions[2], rewards[2], next_state, dones[2]))
            state = next_state
...
def test_td3(
        env,
        test_dir="test/ue_3/TD3/",
        max_episodes=1,
        max_iters=1500,
        device='cpu',
        path1 = f'checkpoints/TD3_15/2022_11_17_13_06_26/TD3_slice1_60_actor.pth',
        path2 = f'checkpoints/TD3_15/2022_12_01_12_36_09/TD3_slice2_60_actor.pth',
